                  ...
                  <div className="relative z-20 flex items-center justify-between">
                    <div className="w-full max-w-[477px]">
                      <span className="hero-subtitle-gradient relative mb-4 inline-flex items-center gap-2 rounded-full px-4.5 py-2 text-sm font-medium">
                        ...
                        <span className="hero-subtitle-text">{t("section1_subtitle")}</span>
                      </span>
                      <h3 className="mb-4.5 text-heading-4 font-bold text-white">{t("section1_title")}</h3>
                      <p className="mb-10 font-medium">{t("section1_description")}</p>
                    </div>
              ...
              <div className="features-box-border relative rounded-3xl">
                <div className="box-hover box-hover-small relative overflow-hidden rounded-3xl px-11 pb-14 pt-12.5">
                  <div className="relative z-20">
                    ...
                    <h3 className="mb-4.5 text-heading-6 font-semibold text-white">{t("section2_title")}</h3>
                    <p className="font-medium">{t("section2_description")}</p>
                  </div>
              ...
              <div className="featuresIssuer-box-border relative rounded-3xl">
                <div className="box-hover box-hover-small relative overflow-hidden rounded-3xl px-11 pb-14 pt-12.5">
                  <div className="relative z-20">
                    ...
                    <h3 className="mb-4.5 text-heading-6 font-semibold text-white">{t("section3_title")}</h3>
                    <p className="font-medium">{t("section3_description")}</p>
                  </div>
                  <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
